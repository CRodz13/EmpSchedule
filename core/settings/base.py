...
TEMPLATES = [
    {
        ...
        'DIRS': [str(ROOT_DIR / "apps/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ADMINS = [("""Chris Rodriguez""", "rodcee13@gmail.com")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "EmpSchedule API",
    "DESCRIPTION": "Documentation of API endpoints of EmpSchedule",
    "VERSION": "1.0.0",
